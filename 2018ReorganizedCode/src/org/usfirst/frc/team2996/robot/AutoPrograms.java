...
public class AutoPrograms extends AutoMethods{
	...
	public void putAutoNumbers() {
		...
		SmartDashboard.putNumber("Left Switch Forward Distance 1", 150);
		SmartDashboard.putNumber("Left Switch Turn Angle", 90);
		SmartDashboard.putNumber("Left Switch Forward Distance 2", 24);
		...
		SmartDashboard.putNumber("Left Cross Line Forward Distance", 130);
		...
		SmartDashboard.putNumber("Right Switch Forward Distance 1", 150);
		SmartDashboard.putNumber("Right Switch Turn Angle", -90);
		SmartDashboard.putNumber("Right Switch Forward Distance 2", 24);
		
		SmartDashboard.putNumber("Right Scale Forward Distance", 200);
		SmartDashboard.putNumber("Right Scale Lift Time", 1);
		
		SmartDashboard.putNumber("Right Cross Line Forward Distance", 130);
	...
	public void leftSwitch() {
		...
		case DRIVING_FORWARD:
			...
			break;
		case TURNING:
			if (navX.getAngle() <= leftSwitchTurnAngle) {
...
//			System.out.println("Distance" + middleCrossLineForwardDistance);
	...
	public void rightSwitch() {
		...
		case DELAY:
			...
			break;
		case DRIVING_FORWARD:
			SmartDashboard.putNumber("Fwd Dist 1", rightSwitchForwardDistance1);
			...
			break;
		case TURNING:
			System.out.println("Angle" + rightSwitchTurnAngle);
			System.out.println("Gyro Angle" + navX.getAngle());
			if (navX.getAngle() >= rightSwitchTurnAngle) {
				robotDrive.curvatureDrive(autoDriveSpeed, autoTurnSpeed, true);
			} else {
				robotDrive.curvatureDrive(0, 0, false);
				resetEncoder();
			...
			break;
		case DRIVING_FORWARD_AGAIN:
			SmartDashboard.putNumber("Fwd Dist 2", rightSwitchForwardDistance2);
